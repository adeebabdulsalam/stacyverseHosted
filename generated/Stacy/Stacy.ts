...
export class CreateERC1155_v1 extends ethereum.Event {
  get params(): CreateERC1155_v1__Params {
    return new CreateERC1155_v1__Params(this);
  }
}

export class CreateERC1155_v1__Params {
  _event: CreateERC1155_v1;

  constructor(event: CreateERC1155_v1) {
    this._event = event;
  }
...
export class Stacy__feesResult {
  value0: Address;
  value1: BigInt;
...
export class Stacy extends ethereum.SmartContract {
  static bind(address: Address): Stacy {
    return new Stacy("Stacy", address);
  }
  ...
  fees(param0: BigInt, param1: BigInt): Stacy__feesResult {
    let result = super.call("fees", "fees(uint256,uint256):(address,uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0),
      ethereum.Value.fromUnsignedBigInt(param1)
    ]);

    return new Stacy__feesResult(result[0].toAddress(), result[1].toBigInt());
  }

  try_fees(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<Stacy__feesResult> {
    let result = super.tryCall(
      "fees",
    ...
    return ethereum.CallResult.fromValue(
      new Stacy__feesResult(value[0].toAddress(), value[1].toBigInt())
    );
  }
